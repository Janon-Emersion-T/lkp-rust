...
pub fn public_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/robot.txt", get(robot_alias))
        .route("/llms.txt", get(llms_txt))
        .route("/llmo.txt", get(llmo_alias))
        ...
        .route("/service-area", get(service_area_alias))
        .route("/service-areas", get(service_areas))
        .route("/service-area/{slug}", get(service_area_single_alias))
        .route("/service-areas/{slug}", get(service_area_single))
        .route("/industries", get(industries))
        .route("/portfolio", get(portfolio_alias))
        .route("/portfolio/{slug}", get(portfolio_single_alias))
